...
## How to run:  
1) Copy gulp-example-project.bat for each Mendix project you want to style using MxGulp. Make sure to keep the new .bat file inside your MxGulp directory.
